...
const AboutUs = () => {
    ...
    return (
      ...
      <div className="relative h-screen w-full">
        <Navbar />
        <div className="absolute inset-0 bg-cover bg-center blur-sm" style={{ backgroundImage: "url('../../public/aavhanLogo.png')" }}></div>
        ...
        <div className="relative flex flex-col items-center justify-center h-full  bg-opacity-50">
          <div className="text-center text-black p-8 rounded-lg  dark:text-white">
            <div className="flex items-center justify-center mb-4">
              <img src="../../public/aavhanLogo.png" alt="Company Logo" className="w-24 h-24 mr-2 bounce logo mt-10" />
